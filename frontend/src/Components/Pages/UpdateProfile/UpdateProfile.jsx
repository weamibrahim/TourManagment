...
function UpdateProfile() {
  ...
  const handleUpdate = (event) => {
    ...
    fetch(
      `https://tour-managment-three.vercel.app/api/users/update/${user._id}`,
      {
        method: "PUT",
        headers: {
              ...
              <form onSubmit={handleUpdate}>
                <div className="card-body m-2 ">
                  <div className="row mb-3 ">
                    <div className="col-sm-2 mt-3">Name</div>
                    ...
                    <div className="col-sm-10 text-secondary">
                      ...
                      <input
                        type="text"
                        placeholder="Name"
                        className="pt-2 form-control mt-3"
                        value={inputs.name}
                        name="name"
                ...
                <div className="card-body m-2 ">
                  <div className="row mb-3 ">
                    <div className="col-sm-2 mt-3">email</div>
                    <div className="col-sm-10 text-secondary">
                      <input
                        type="email"
                        placeholder="Email"
...
export default PageTransition(UpdateProfile);
