          ...
          <div className="col-md-7 my-4 ">
            <div className="card rounded-top-4">
              <img
                ...
                src={
                  "https://tour-managment-three.vercel.app/images/" + tour.photo
                }
              />
              <div className="card-body">
                ...
                <div className="row">
                  ...
                  <div className="col-md-4 mb-2">
                    <p>
                      <CiLocationOn className="fs-5 text-warning" />
                      {tour.city}
                    </p>
                  </div>
                  <div className="col-md-4 mb-2">
                    <p>
                      <RiPinDistanceLine className="fs-5 text-warning" />
                      {tour.distance}
                    </p>
                  </div>
                  <div className="col-md-4 mb-2">
                    <p>
                      <MdStreetview className="fs-5 text-warning" />
                      {tour.address}
                    </p>
                  </div>
                  <div className="col-md-4 mb-2">
                    <p>
                      <MdOutlinePeople className="fs-5 text-warning" />
                ...
                tour.reviews.map((review) => (
                  <div key={review._id} className="row">
                    <div className="col-md-10">
                      <p>
                        <MdOutlinePerson className="fs-3" />
