                ...
                <div className="container py-5">
                    <div className="row g-5">
                        <div className="col-lg-4 col-md-6">
                            <h4 className="section-title ff-secondary text-start fw-normal mb-4" style={{color:"blue"}}>Company</h4>
                        ...
                        <div className="col-lg-4 col-md-6">
                            <h4 className="section-title ff-secondary text-start  fw-normal mb-4"  style={{color:"blue"}}>Contact</h4>
                        ...
                        <div className="col-lg-4 col-md-6">
                            <h4 className="section-title ff-secondary text-start  fw-normal mb-4"  style={{color:"blue"}}>Newsletter</h4>
                            <p>Dolor amet sit justo amet elitr clita ipsum elitr est.</p>
                            <div className="position-relative mx-auto" style={{ maxWidth: '400px' }}>

                                <button type="button" className="btn py-2 position-absolute my-3"  style={{backgroundColor:"blue"}}>SignUp</button>
                            </div>
                        </div>
                    </div>
                </div>
